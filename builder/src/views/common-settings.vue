  ...
  <div class="b-selzy-app-common-settings b-selzy-app__common-settings">
    <div class="b-selzy-app-common-settings__header">
      <div class="b-selzy-app-common-settings__tab-buttons">
        <div
          class="b-selzy-app-common-settings__tab-button"
      ...
      <div
        class="b-selzy-app-common-settings__toggle-button"
    ...
    <div
      class="b-selzy-app-common-settings__main"
      :class="showContent ? 'active' : ''"
    >
      <div
        class="b-selzy-app-common-settings__tab-content"
...
export default {
  ...
  data() {
    return {
      ...
      tabs: {
        buttons: [
          this.$i18n.t("form.title"),
          this.$i18n.t("message.title"),
          this.$i18n.t("double_optin.title"),
        ],
      },
      showContent: true,
    };
