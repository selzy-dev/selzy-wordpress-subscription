  ...
  <div class="b-selzy-app__wrap">
    ...
    <div class="b-selzy-app__main">
      <div class="b-selzy-app__accordions">
        <draggable v-model="items" handle="[name=draggable]">
          <FieldAccordion
            class="b-selzy-app__accordion"
      ...
      <v-row justify="end">
        <v-col cols="12" align="right">
          <div class="b-selzy-app__button-container">
            <div
              class="b-types-list b-selzy-app__types"
              :class="typesContainerShow ? 'active' : ''"
            >
              <div
                class="b-types-list__item"
